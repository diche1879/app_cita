...
/* RUTA RESERVAR CITA NO AUTOMATIZADA */
routerUser.post('/reserve_cita', verifyToken, (req, res) => {
    const userId = req.userId;
    const { date, hour, firstName, surname } = req.body;
...
/* RUTA CONFIRMACIÓN */
routerUser.get('/confirmation', verifyToken, (req, res) => {
